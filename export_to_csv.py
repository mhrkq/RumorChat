...
from main import app, db, Rooms, Messages, ChatbotMessages, Comments, CommentVotes
...
def export_to_csv():
    ...
    with app.app_context():
        tables = [Rooms, Messages, ChatbotMessages, Comments, CommentVotes]
        filenames = []
...
def reset_database():
    with engine.connect() as connection:
        for table in [Rooms.__tablename__, Messages.__tablename__, ChatbotMessages.__tablename__, Comments.__tablename__, CommentVotes.__tablename__]:
